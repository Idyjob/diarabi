...
use Settings\SettingsBundle\Entity\Pages;
use Settings\SettingsBundle\Form\Type\PagesType;
use Settings\SettingsBundle\Form\Type\PagesFilterType;
...
class PagesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $qb = $em->getRepository('SettingsBundle:Pages')->createQueryBuilder('p');
        $paginator = $this->filter($form, $qb, 'pages');
                return $this->render('SettingsBundle:Pages:index.html.twig', array(
    ...
    public function showAction(Pages $pages)
    {
        ...
        return $this->render('SettingsBundle:Pages:show.html.twig', array(
            'pages' => $pages,
    ...
    public function newAction()
    {
        ...
        return $this->render('SettingsBundle:Pages:new.html.twig', array(
            'pages' => $pages,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Pages $pages)
    {
        ...
        return $this->render('SettingsBundle:Pages:edit.html.twig', array(
            'pages' => $pages,
