...
class MediaAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $qb = $em->getRepository('FrontendBundle:Media')->createQueryBuilder('m');
    ...
    public function showAction(Media $media)
    {
        ...
        return $this->render('FrontendBundle:Media:show.html.twig', array(
            'media' => $media,
    ...
    public function newAction()
    {
        ...
        return $this->render('FrontendBundle:Media:new.html.twig', array(
            'media' => $media,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Media $media)
    {
        ...
        return $this->render('FrontendBundle:Media:edit.html.twig', array(
            'media' => $media,
