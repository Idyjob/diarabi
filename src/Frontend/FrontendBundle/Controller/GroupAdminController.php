...
use Frontend\FrontendBundle\Entity\Group;
use Frontend\FrontendBundle\Form\Type\GroupType;
use Frontend\FrontendBundle\Form\Type\GroupFilterType;
...
class GroupAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $qb = $em->getRepository('FrontendBundle:Group')->createQueryBuilder('g');
        $paginator = $this->filter($form, $qb, 'group');
                return $this->render('FrontendBundle:Group:index.html.twig', array(
    ...
    public function showAction(Group $group)
    {
        ...
        return $this->render('FrontendBundle:Group:show.html.twig', array(
            'group' => $group,
    ...
    public function newAction()
    {
        ...
        return $this->render('FrontendBundle:Group:new.html.twig', array(
            'group' => $group,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Group $group)
    {
        ...
        return $this->render('FrontendBundle:Group:edit.html.twig', array(
            'group' => $group,
