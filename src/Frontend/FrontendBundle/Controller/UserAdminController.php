...
use Frontend\FrontendBundle\Form\Type\UserType;
use Frontend\FrontendBundle\Form\Type\UserFilterType;
...
class UserAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $qb = $em->getRepository('FrontendBundle:User')->createQueryBuilder('u');
        $paginator = $this->filter($form, $qb, 'user');
                return $this->render('FrontendBundle:User:index.html.twig', array(
    ...
    public function showAction(User $user)
    {
        ...
        return $this->render('FrontendBundle:User:show.html.twig', array(
            'user' => $user,
    ...
    public function newAction()
    {
        ...
        return $this->render('FrontendBundle:User:new.html.twig', array(
            'user' => $user,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(User $user)
    {
        ...
        return $this->render('FrontendBundle:User:edit.html.twig', array(
            'user' => $user,
