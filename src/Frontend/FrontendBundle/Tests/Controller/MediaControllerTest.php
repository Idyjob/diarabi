...
class MediaControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'media[slug]' => 'Lorem ipsum dolor sit amet',
            'media[path]' => 'Lorem ipsum dolor sit amet',
            'media[updatedAt]' => new \DateTime(),
            'media[mediatype]' => 'Lorem ipsum dolor sit amet',
            'media[mediasize]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'media[path]' => 'Changed',
            'media[updatedAt]' => new \DateTime(),
            'media[mediatype]' => 'Changed',
            'media[mediasize]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            ...
            'media_filter[slug]' => 'First%',
            'media_filter[path]' => 'First%',
            'media_filter[updatedAt]' => new \DateTime(),
            'media_filter[mediatype]' => 'First%',
            'media_filter[mediasize]' => 'First%',
